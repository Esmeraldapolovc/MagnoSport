...
export default defineConfig({
 ...
 manifest: {
        name: 'MagnoSPort',
        short_name: 'MagnoSPort',
        description: 'Universidad Magno',
        theme_color: '#ffffff',
        includeAssets: ['/android', '/ios', '/windows'],
        "icons": [
    {
   ...
   screenshots: [
    {
      src: "/public/screenshots/Escritorio.png", 
      sizes: "1919x1079",
      type: "image/png",
      form_factor: "wide", 
      label: "Pantalla principal de MagnoSPort en escritorio"
    },
    {
      src: "/public/screenshots/movil.png", 
      sizes: "834x532", 
      type: "image/png",
      form_factor: "narrow", 
      label: "Pantalla principal de MagnoSPort en móvil"
    }
  ]
      }
  })],
